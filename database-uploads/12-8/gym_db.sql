...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2025 at 05:42 AM
...
(7, 25, 78, '2025-12-07', 'Standard gym membership agreement.', NULL),
(8, 25, 79, '2025-12-07', 'Standard gym membership agreement.', NULL);
...
(13, 'Chris', 'Anderson', 'M.J Cuenco', 'Liloan', 'asdad', '6000', 'Male', '1989-04-15', '09123456700', 'chris.anderson@email.com', '2024-03-07', 'Simon Anderson', '09123450011', 'Inactive', ''),
...
(24, 'Dedge', 'Baguio', 'Purok Tambis', 'Liloan', '0oiajskdiopasd', '6002', 'Male', '2003-09-11', '09123454512', 'dedge@example.com', '2025-09-02', 'Carlo Caliao', '09121254534', 'Pending', NULL),
(25, 'Dodge', 'Baguio', 'asdasd', 'asdasd', 'adasdasdsad', '1111', 'Male', '2004-02-07', '09121212121', 'dodge@example.com', '2025-12-07', 'asdasdasd', '09454545454', 'Active', NULL);
...
(5, '6 months membership', 'test', 'Months', 6, 8000.00, 0);
...
--
ALTER TABLE `agreement`
  MODIFY `AgreementID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `membership`
  MODIFY `MembershipID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;

--
-- AUTO_INCREMENT for table `payment`
--
ALTER TABLE `payment`
  MODIFY `PaymentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
