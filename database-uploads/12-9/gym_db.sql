...
(9, 3, 83, '2025-12-09', 'Standard gym membership agreement.', NULL);
...
(29, 'DingDong', 'Dantes', 'Dingdong Street', 'Caloocan', 'Metro Manila', '1111', 'Male', '1995-05-10', '09123456767', 'ding@dong.com', '2025-12-08', 'asdasdasd', '0900000000', 'Pending', NULL, 2, '2025-12-08 14:50:36');
...
(2, 'Update', 'Doe', 'admin@example.com', '09175550123', NULL, 1, 'admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-11-19', 'Active', '2025-12-09 13:50:41', '2025-12-08 04:44:29', '2025-12-09 05:50:41', NULL, 2),
...
--
ALTER TABLE `agreement`
  MODIFY `AgreementID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `membership`
  MODIFY `MembershipID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
